...
As IAM solution I decided to use the great [keycloak toolkit !](https://www.keycloak.org/). The access proxy is based on the known Apache 2 server with mode-auth-openidc ![](https://github.com/zmartzone/mod_auth_openidc). All external facing certificas were issued by the [letsencrypt ca](https://letsencrypt.org/).
